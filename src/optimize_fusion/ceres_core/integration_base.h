  ...
  public:
                            ...
                            Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        if(update_jacobian)
        {
            ...
            // std::cout << "in midPointIntegration, test jacobian" << std::endl;
            // // std::cout << jacobian << std::endl;
            // std::cout << "------" << std::endl;
            // // std::cout << covariance << std::endl;
            // std::cout << covariance.block<6,6>(0,0) << std::endl;
            // std::cout << "------" << std::endl;
            // // std::cout << noise << std::endl;
            // std::cout << "_dt : " << _dt << std::endl;
            // // std::cout << "------" << std::endl;
            // // std::cout << V << std::endl;
            // std::cout << "cur_imu_cnt : " << cur_imu_cnt++ << std::endl;
        }
    }
                                          ...
                                          const Eigen::Vector3d &Pj, const Eigen::Quaterniond &Qj, const Eigen::Vector3d &Vj, const Eigen::Vector3d &Baj, const Eigen::Vector3d &Bgj)
    {
        ...
        // std::cout << "corrected_delta_p : " << corrected_delta_p.transpose() << std::endl;
        // std::cout << "Pi : " << Pi.transpose() << std::endl;
        // std::cout << "Pj : " << Pj.transpose() << std::endl;
        // std::cout << "predict : " << (Pi + Vi * sum_dt - 0.5 * config.G * sum_dt * sum_dt + Qi*corrected_delta_p).transpose() << std::endl;

        // std::cout << "corrected_delta_v : " << corrected_delta_v.transpose() << std::endl;
        // std::cout << "Qi : " << Qi.coeffs().transpose() << std::endl;
        // std::cout << "Vi : " << Vi.transpose() << std::endl;
        // std::cout << "Vj : " << Vj.transpose() << std::endl;
        // std::cout << "predict : " << (Vi - config.G * sum_dt + Qi*corrected_delta_v).transpose() << std::endl;
        // std::cout << "residuals.block<3, 1>(O_V, 0) : " << residuals.block<3, 1>(O_V, 0).transpose() << std::endl;
